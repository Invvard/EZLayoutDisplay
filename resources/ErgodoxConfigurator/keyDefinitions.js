...
export const keyCategories = {
  ...
  digit: "Digits",
  letters: "Letters",
  dualFunction: "Dual-function keys",
  fn: "Fn keys",
  fw: "Firmware",
  lang: "Language",
  layer: "Layer switch",
  layerShortcuts: "Layer Shortcuts",
  media: "Media",
  modifier: "Modifiers",
  momentary: "Momentary layer switch",
  mouse: "Mouse control",
  nav: "Navigational",
  nordic: "Nordic",
  numpad: "Numpad",
  other: "Other",
  punct: "Punctuation",
  shiftedPunct: "Shifted punctuation",
  shine: "EZ Shine control",
  shortcuts: "Shortcuts",
  spacing: "Spacing",
...
export const keyCodes = {
  ...
  NO_HALF: { label: "½", category: "nordic" },
  NO_PLUS: { label: "+", category: "nordic" },
  NO_ACUT: { label: "'", category: "nordic" },
  NO_AM: { label: "å", category: "nordic" },
  NO_QUOT: { label: '"', category: "nordic" },
  NO_AE: { label: "ø", category: "nordic" },
  NO_OSLH: { label: "æ", category: "nordic" },
  NO_APOS: { label: "'", category: "nordic" },
  NO_LESS: { label: "<", category: "nordic" },
  NO_MINS: { label: "-", category: "nordic" },
  NO_QUO2: { label: "NO_QUO2", category: "nordic" },
  NO_BULT: { label: "NO_BULT", category: "nordic" },
  NO_AMPR: { label: "&", category: "nordic" },
  NO_SLSH: { label: "/", category: "nordic" },
  NO_LPRN: { label: "(", category: "nordic" },
  NO_RPRN: { label: ")", category: "nordic" },
  NO_EQL: { label: "=", category: "nordic" },
  NO_QUES: { label: "?", category: "nordic" },
  NO_GRV: { label: "`", category: "nordic" },
  NO_CIRC: { label: "^", category: "nordic" },
  NO_GRTR: { label: ">", category: "nordic" },
  NO_SCLN: { label: ";", category: "nordic" },
  NO_COLN: { label: ":", category: "nordic" },
  NO_UNDS: { label: "_", category: "nordic" },
  NO_AT: { label: "@", category: "nordic" },
  NO_PND: { label: "#", category: "nordic" },
  NO_LCBR: { label: "¶", category: "nordic" },
  NO_LBRC: { label: "[", category: "nordic" },
  NO_RBRC: { label: "]", category: "nordic" },
  NO_RCBR: { label: "≠", category: "nordic" },
  NO_PIPE: { label: "<", category: "nordic" },
  NO_EURO: { label: "€", category: "nordic" },
  NO_TILD: { label: "~", category: "nordic" },
  NO_MU: { label: "NO_MU", category: "nordic" },
  DE_Z: { label: "German Z", category: "nordic" },
  DE_Y: { label: "German Y", category: "nordic" },
  DE_SS: { label: "German ß", category: "nordic" },
  DE_AE: { label: "German Æ", category: "nordic" },
  DE_UE: { label: "German Ü", category: "nordic" },
  DE_OE: { label: "German Ö", category: "nordic" },
  DE_CIRC: {
    label: "German ^°",
    category: "nordic"
  },
  ...
  DE_HASH: { label: "German #'", category: "nordic" },
  DE_LESS: {
    label: "German <>|",
    category: "nordic"
  },
  DE_MINS: { label: "German -_", category: "nordic" },
  DE_RING: { label: "German °", category: "nordic" },
  DE_EXLM: { label: "German !", category: "nordic" },
  DE_DQOT: { label: 'German "', category: "nordic" },
  DE_PARA: { label: "German §", category: "nordic" },
  DE_DLR: { label: "German $", category: "nordic" },
  DE_PERC: { label: "German %", category: "nordic" },
  DE_AMPR: { label: "German &", category: "nordic" },
  DE_SLSH: { label: "German /", category: "nordic" },
  DE_LPRN: { label: "German (", category: "nordic" },
  DE_RPRN: { label: "German )", category: "nordic" },
  DE_EQL: { label: "German =", category: "nordic" },
  DE_QST: { label: "German ?", category: "nordic" },
  DE_GRV: { label: "German `", category: "nordic" },
  DE_ASTR: { label: "German *", category: "nordic" },
  DE_QUOT: { label: "German '", category: "nordic" },
  DE_MORE: { label: "German >", category: "nordic" },
  DE_COLN: { label: "German :", category: "nordic" },
  DE_SCLN: { label: "German ;", category: "nordic" },
  DE_UNDS: { label: "German _", category: "nordic" },
  DE_SQ2: { label: "German ²", category: "nordic" },
  DE_SQ3: { label: "German ³", category: "nordic" },
  DE_LCBR: { label: "German {", category: "nordic" },
  DE_LBRC: { label: "German [", category: "nordic" },
  DE_RBRC: { label: "German ]", category: "nordic" },
  DE_RCBR: { label: "German }", category: "nordic" },
  DE_BSLS: { label: "German \\", category: "nordic" },
  DE_AT: { label: "German @", category: "nordic" },
  DE_EURO: { label: "German €", category: "nordic" },
  DE_TILD: { label: "German ~", category: "nordic" },
  DE_PIPE: { label: "German |", category: "nordic" },
...
// render the list of keycode in a shape expected by react-select

const keyOptions = [];
const modifierOptions = [];
const colorKeyCodes = [];

function getOption(keyCode, os) {
  const keyOption = this.filter(key => {
    if (os && key.os) return key.value === keyCode && key.os === os;
    return key.value === keyCode;
  })[0];
  return (
    keyOption || {
      category: null,
...
Object.keys(keyCategories).forEach(categoryKey => {
  ...
  categoryKeys.forEach(keyCode => {
    ...
    const arr = modifierCommand === true ? modifierOptions : keyOptions;
    // Exclude option if menuLabel is explicitly false
    // and modifier command keys
    const optionLabel = menuLabel || label;
    if (menuLabel !== false) {
      if (os) {
        Object.keys(os).forEach(val => {
          arr.push({
            category: categoryKey,
            categoryName,
            description: os[val].description || description,
            label: os[val].menuLabel,
            precedingKey,
            value: keyCode,
            os: val
          });
    ...
    if (categoryKey === "shine" && keyCode !== "RGB") {
      colorKeyCodes.push({ code: keyCode, ...key });
    }
  });
});
keyOptions.getOption = getOption;

const commandOptions = keyOptions.filter(
  ({ category }) =>
    ![
      "autoshift",
      "other",
...
commandOptions.getOption = getOption;

modifierOptions.getOption = getOption;

export const selectKeyOptions = keyOptions;
export const selectCommandOptions = commandOptions;
export const selectModifierOptions = modifierOptions;
export const colorCodes = colorKeyCodes;
